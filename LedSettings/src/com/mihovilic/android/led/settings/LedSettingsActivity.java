...
public class LedSettingsActivity extends ListActivity implements OnItemClickListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView) findViewById(R.id.applications_category))
                .setText(R.string.category_applications);
    ...
    private void refreshDefault() {
        mColor = Settings.System.getInt(getContentResolver(),
                NOTIFICATION_LIGHT_PULSE_DEFAULT_COLOR, 0xFFFFFF);
        mTimeOn = Settings.System.getInt(getContentResolver(),
                NOTIFICATION_LIGHT_PULSE_DEFAULT_LED_ON, 1000);
        mTimeOff = Settings.System.getInt(getContentResolver(),
                NOTIFICATION_LIGHT_PULSE_DEFAULT_LED_OFF, 1000);
    ...
    class ApplicationAdapter extends ArrayAdapter<Application> {
        ...
        public View getView(int position, View view, ViewGroup parent) {
            ...
            try {
                PackageInfo info = getPackageManager().getPackageInfo(name,
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        Settings.System.putInt(getContentResolver(), NOTIFICATION_LIGHT_PULSE_CUSTOM_ENABLE,
                ((Switch) findViewById(R.id.checkedViewCustom)).isChecked() ? 1 : 0);
        refreshCustomEnabled();
    }
                ...
                builder.setPositiveButton(android.R.string.ok, new AlertDialog.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        updateValues(
                                ...
                                ((Pair<String, Integer>) ((Spinner) layout
                                        .findViewById(R.id.spinnerColors)).getSelectedItem()).second,
                                ((Pair<String, Integer>) ((Spinner) layout
                                        .findViewById(R.id.spinnerTimeOn)).getSelectedItem()).second,
                                ((Pair<String, Integer>) ((Spinner) layout
                                        .findViewById(R.id.spinnerTimeOff)).getSelectedItem()).second);
                    }
                });
     ...
     * 
     * @param application Package name of aplication specific settings to
    ...
    protected void updateValues(String application, Integer color, Integer timeon, Integer timeoff) {
        if (application == null) {
            Settings.System.putInt(getContentResolver(), NOTIFICATION_LIGHT_PULSE_DEFAULT_COLOR,
                    color);
            Settings.System.putInt(getContentResolver(), NOTIFICATION_LIGHT_PULSE_DEFAULT_LED_ON,
                    timeon);
            Settings.System.putInt(getContentResolver(), NOTIFICATION_LIGHT_PULSE_DEFAULT_LED_OFF,
                    timeoff);
            refreshDefault();
            return;
        }
    ...
    class TimeSpinnerAdapter extends BaseAdapter implements SpinnerAdapter {
        ...
        public TimeSpinnerAdapter(int timesArrayResource, boolean defaul) {
            ...
            if (defaul) {
                ...
                times.add(new Pair<String, Integer>(
        ...
        public TimeSpinnerAdapter(int timesArrayResource, boolean defaul, Integer customTime) {
            ...
            if (getTimePosition(customTime) == -1)
                times.add(new Pair<String, Integer>(getResources().getString(R.string.custom_time),
                        customTime));
        }
        ...
        public View getView(int position, View view, ViewGroup parent) {
            if (view == null)
                view = LayoutInflater.from(getApplicationContext()).inflate(R.layout.time_item,
                        null);
    ...
    class ColorSpinnerAdapter extends BaseAdapter implements SpinnerAdapter {
        ...
        public ColorSpinnerAdapter(int colorsArrayResource, boolean defaul) {
            ...
            if (defaul) {
                // Add the Default entry first
                colors.add(new Pair<String, Integer>(getResources().getString(
         ...
         * 
         * @param colorsArrayResource The time entry array
        ...
        public ColorSpinnerAdapter(int colorsArrayResource, boolean defaul, Integer customColor) {
            ...
            if (getColorPosition(customColor) == -1)
                colors.add(new Pair<String, Integer>(getResources()
                        .getString(R.string.custom_color), customColor));
        }
        ...
        public View getView(int position, View view, ViewGroup parent) {
            ...
            if (view == null) {
                view = LayoutInflater.from(getApplicationContext()).inflate(R.layout.color_item,
                        null);
